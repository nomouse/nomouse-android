...
import com.tixa.lx.servant.R;
import com.tixa.thirdpartylibs.pulltorefresh.library.PullToRefreshBase.AnimationStyle;
import com.tixa.thirdpartylibs.pulltorefresh.library.PullToRefreshBase.Mode;
import com.tixa.thirdpartylibs.pulltorefresh.library.PullToRefreshBase.OnLastItemVisibleListener;
import com.tixa.thirdpartylibs.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import com.tixa.thirdpartylibs.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
...
public class PageListView<T> extends FrameLayout {
    ...
    private OnRefreshListener<ListView> onRefreshListener;
    private OnRefreshListener2<ListView> onRefreshListener2;
    ...
    protected void checkMainList() {
        ...
        if (flag) {
            if (mainListView == null) {
                // ListView FooterView
                footerContainer = inflater.inflate(R.layout.listview_footer_container,
                        null);
